    ...
    if (!isDevice)
      return Promise.resolve([
        ...
        },
        {
          ...
          role: '',
          stats: {
            [NetworkType.Wifi]: [{ date: new Date(), received: 3000000, sent: 1 }],
            [NetworkType.Sim1]: [{ date: new Date(), received: 20000000, sent: 1 }],
            [NetworkType.Sim2]: [],
          },
        },
        {
          ...
          role: '',
          stats: {
            [NetworkType.Wifi]: [{ date: new Date(), received: 5000000, sent: 1 }],
            [NetworkType.Sim1]: [{ date: new Date(), received: 20000000, sent: 1 }],
            [NetworkType.Sim2]: [],
          },
        },
        {
          ...
          role: '',
          stats: {
            [NetworkType.Wifi]: [{ date: new Date(), received: 32000000, sent: 1 }],
            [NetworkType.Sim1]: [{ date: new Date(), received: 20000000, sent: 1 }],
            [NetworkType.Sim2]: [],
          },
        },
        {
          ...
          role: '',
          stats: {
            [NetworkType.Wifi]: [{ date: new Date(), received: 16000000, sent: 1 }],
            [NetworkType.Sim1]: [{ date: new Date(), received: 20000000, sent: 1 }],
            [NetworkType.Sim2]: [],
          },
        },
